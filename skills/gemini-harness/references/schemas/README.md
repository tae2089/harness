...
2. **Step 1.3 of orchestrator (runtime):** main이 8개 파일 각각 `read_file` → `write_file`으로 `_workspace/_schemas/`에 동기화. `workflow.md`, `findings.md`, `tasks.md`, `checkpoint.json`도 템플릿 기반으로 작성.
