...
> 상세 다이어그램·조율 방식은 `references/agent-design-patterns.md` 참조.
...
| 전략                     | 방식                                                                            | 적합한 경우                               |
| ------------------------ | ------------------------------------------------------------------------------- | ----------------------------------------- |
| **파일 기반 (기본)**     | `_workspace/`에 약속된 경로로 산출물 기록                                       | 대용량 데이터, 구조화된 산출물, 감사 추적 |
